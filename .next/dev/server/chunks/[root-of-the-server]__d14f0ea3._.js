    ...
    providers: [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$providers$2f$credentials$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials) {
                ...
                const member = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].member.findUnique({
                    where: {
                ...
                const isPasswordValid = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compare(credentials.password, member.password);
                if (!isPasswordValid) {
                    throw new Error('Neispravni podaci za prijavu');
                }
                return {
...
"[project]/lib/services/balance.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function addTokens(memberId, amount, type, description) {
    // Use Prisma transaction for atomic update
    const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction(async (tx)=>{
        // Get current balance
        ...
        const balanceTransactions = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCollection"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["COLLECTIONS"].BALANCE_TRANSACTIONS);
        await balanceTransactions.insertOne({
            memberId,
            amount,
            type,
            description,
...
async function deductTokens(memberId, amount, type, description) {
    // Use Prisma transaction for atomic update
    const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction(async (tx)=>{
        // Get current balance
        const member = await tx.member.findUnique({
...
async function getBalanceHistory(memberId, limit = 50) {
    const balanceTransactions = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCollection"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mongodb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["COLLECTIONS"].BALANCE_TRANSACTIONS);
    const transactions = await balanceTransactions.find({
        memberId
    }).sort({
        createdAt: -1
    }).limit(limit).toArray();
...
async function hasInsufficientBalance(memberId, requiredAmount) {
    const balance = await getBalance(memberId);
    return balance < requiredAmount;
}
}),
"[project]/lib/services/products.ts [app-route] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/prisma.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$balance$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/services/balance.ts [app-route] (ecmascript)");
;
;
...
async function getPlatformConfig(key) {
    const config = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].platformConfig.findUnique({
        where: {
            key
        }
    });
...
async function calculateListingFee(sellerId) {
    ...
    const productCount = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].product.count({
        where: {
            sellerId
        }
    });
...
async function canCreateProduct(sellerId) {
    ...
    const insufficient = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$balance$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasInsufficientBalance"])(sellerId, fee);
    if (insufficient) {
        return {
            canCreate: false,
            fee,
...
async function createProductWithFee(sellerId, data) {
    ...
    const product = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction(async (tx)=>{
        // Create product
        ...
        if (fee > 0) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$balance$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deductTokens"])(sellerId, fee, 'listing_fee', `Naknada za objavljivanje proizvoda: ${data.name}`);
        }
        return newProduct;
    });
    return product;
}
async function getSellerListingStats(sellerId) {
    const freeTierLimit = await getPlatformConfig('free_tier_limit');
    const productCount = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].product.count({
        where: {
            sellerId
...
const cloudName = process.env.CLOUDINARY_CLOUD_NAME || ("TURBOPACK compile-time value", "dp7xzaj9r");
...
async function uploadImage(file, folder = 'products') {
    try {
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cloudinary$2f$cloudinary$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["v2"].uploader.upload(uploadSource, {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/prisma.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$products$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/lib/services/products.ts [app-route] (ecmascript) <locals>");
...
const createProductSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    name: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(3, 'Naziv mora imati najmanje 3 karaktera'),
    description: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(10, 'Opis mora imati najmanje 10 karaktera'),
    price: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().int().positive('Cena mora biti pozitivan broj'),
    categoryId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string(),
    images: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].array(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string()).min(1, 'Potrebna je najmanje 1 slika').max(5, 'Maksimalno 5 slika')
});
    ...
    if (contentType.includes('multipart/form-data')) {
        ...
        for (const item of imageItems){
            if (item instanceof File) {
                ...
                const imageUrl = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cloudinary$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["uploadImage"])(item);
...
async function GET(request) {
    try {
        ...
        const promotedProducts = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].product.findMany({
            where: {
                ...where,
                isPromoted: true
            },
...
async function POST(request) {
    try {
        ...
        const product = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$products$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createProductWithFee"])(sellerId, validatedData);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            product,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d14f0ea3._.js.map