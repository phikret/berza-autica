      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-4 text-center text-sm text-gray-600">
            Ako niste primili verifikacijski email, unesite svoju email adresu pa ćemo vam ga ponovo poslati.
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          {success && (
            <div className="rounded-md bg-green-50 p-4">
              ...
              <p className="text-xs text-green-700 mt-2">
                Ako nije primljena u roku od nekoliko minuta, provjerite spam folder.
              </p>
            </div>
          )}
          ...
          <div className="text-center space-y-2">
            <Link
              href="/auth/register"
              className="block font-medium text-primary-600 hover:text-primary-500 text-sm"
            >
