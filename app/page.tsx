...
function ProductCard({ product, promoted = false }: { product: any; promoted?: boolean }) {
  return (
    <Link href={`/products/${product.slug}`}>
      <div className={`bg-white rounded-lg shadow hover:shadow-lg transition-shadow ${promoted ? 'ring-2 ring-yellow-400' : ''}`}>
        ...
        <div className="p-4">
          ...
          <div className="flex justify-between items-center">
            <span className="text-xl font-bold text-primary-600">{product.price} RSD</span>
